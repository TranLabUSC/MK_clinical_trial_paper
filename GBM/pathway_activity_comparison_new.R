...
for (pathway in pathways){
  for (celltype in unique(celltype_to_cluster$celltype)){
    ...
    if(include_cluster_proportion){
      if (method == "difference") {
        plot_dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/with_cluster_proportion/difference/"
      } else {
        plot_dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/with_cluster_proportion/ratio/"
      }
    } else {
      if (method == "difference") {
        plot_dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/without_cluster_proportion/difference/"
      } else {
        plot_dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/without_cluster_proportion/ratio/"
      }
    }
...
if(include_cluster_proportion){
  if (method == "difference") {
    dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/with_cluster_proportion/difference/"
  } else {
    dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/with_cluster_proportion/ratio/"
  }
} else {
  if (method == "difference") {
    dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/without_cluster_proportion/difference/"
  } else {
    dir <- "/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Pathway_Activity_Comparison_Results/without_cluster_proportion/ratio/"
  }
}
