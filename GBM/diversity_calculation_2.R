...
{
  setwd("/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Clonal_Expansion_Results")
  file_path = paste0("/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/Finale/Clonal_Expansion_Results/clonotype_df_proportion_", celltype, "_T_cells.csv")
