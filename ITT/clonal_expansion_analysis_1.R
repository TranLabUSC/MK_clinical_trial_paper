...
for (celltype in unique(celltype_to_cluster$celltype)){
  ...
  write.csv(clonotype_df_absolute, paste0("/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/ITT/Clonal_Expansion_Results/final_nomenclature/clonotype_df_absolute_", celltype, "_T_cells.csv"))
  ...
  write.csv(proportion_df, paste0("/project/dtran642_927/Data/Collaborator/DJ/scRNAseq/latest_big_sequencing_projects/MK/new_sequencing_data/ITT/Clonal_Expansion_Results/final_nomenclature/clonotype_df_proportion_", celltype, "_T_cells.csv"))
}
